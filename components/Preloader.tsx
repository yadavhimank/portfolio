...
const Preloader = () => {
    ...
    return (
        <div className="fixed inset-0 z-[4] flex" ref={preloaderRef}>
            ...
            <p className="name-text text-[20vw] lg:text-[200px] font-anton text-center absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 leading-none overflow-hidden">
